...
NISKALA_IMG = "https://telegra.ph/file/e3e3cd9caf4ab45f0fc50.jpg"

PM_START_TEXT = """
*ʜᴇʟʟᴏ {}, ɪ'ᴍ 𝐀𝐋𝐞𝐱𝐗!*
✪ `ɪ'ᴍ ᴀɴ ᴀɴɪᴍᴇ-ᴛʜᴇᴍᴇ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʀᴏʙᴏᴛ​` [✨](https://telegra.ph/file/e3e3cd9caf4ab45f0fc50.jpg)
────────────────────
× *Uᴘᴛɪᴍᴇ:* `{}`
× `{}` *Uꜱᴇʀ, Aᴄʀᴏꜱꜱ* `{}` *Cʜᴀᴛꜱ.*
────────────────────
✪ `ʜɪᴛ` /help `ᴛᴏ sᴇᴇ ᴍʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs.`
✪ `ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ` `ʙʏ` @ygmutebabi
"""

buttons = [
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ 𝐀𝐋𝐞𝐱𝐗", callback_data="ALexX_about"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="💢 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ 💢", url="http://t.me/lexmusicbot?startgroup=true"),
    ],
]
...
def niskala_about_callback(update, context):
    ...
    if query.data == "niskala_":
        query.message.edit_text(
            ...
            f"\n\n*Jika Ada Keluhan. Harap Hubungi @ygmutebabi*",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Kemudian Kirim ` `/admincache@lexmusicbot` `Di Obrolan Itu Untuk Menyegarkan Daftar Admin Di Database Saya.`\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aᴅᴍɪɴ", callback_data="ALexX_admin"),
                    InlineKeyboardButton(text="Nᴏᴛᴇꜱ", callback_data="ALexX_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", callback_data="ALexX_support"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/gabutanguwa"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/gabutanguwa"),
                 ],
                 [
                    InlineKeyboardButton(text="Bᴀᴄᴋ", callback_data="ALexX_about"),
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1703479732 and DONATION_LINK:
            update.effective_message.reply_text(
