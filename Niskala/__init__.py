...
def get_user_list(__init__, key):
    with open("{}/ALexX/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[ALexX] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[ALexX]')
LOGGER.info("ALexX is starting. | An ygmutebabi Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/alexxxxx87 (t.me/ygmutebabi)")
...
DRAGONS.add(1703479732)
DRAGONS.add(1338853808)
DRAGONS.add(1920507972)
DEV_USERS.add(1703479732)
